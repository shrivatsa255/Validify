  ...
  return (
    <div className="flex justify-center sm:px-6 p-12">
      <div className="w-full minmd:w-4/5">
        <DynamicBanner
          parentStyles="justify-start mb-6 h-72 sm:h-60 sm:p-1 p-12 xs:p-4 xs:h-44 rounded-2xl"
          childStyles="md:text-4xl sm:text-2xl sm:text-center xs:text-xl sm:tracking-wide text-left"
      ...
      <DynamicInfoCard
        ...
        <div className="relative flex-1 max-w-full flex mt-3" ref={parentRef}>
          <div
            className="flex flex-row w-max overflow-x-scroll gap-3 no-scrollbar select-none"
            ref={scrollRef}
          >
            <DynamicInfoCard
