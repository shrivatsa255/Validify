...
const InfoCard = ({
  ...
  return (
    <div className="flex-1 min-w-215 break-words max-w-max xs:max-w-none sm:w-full sm:min-w-fit minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-indigo-100 rounded-2xl my-4 ml-4 sm:ml-0 minlg:m-8 sm:my-2  cursor-pointer shadow-md sm:p-10 p-10">
      <div className="relative w-full h-full sm:h-50 xs:h-66 minmd:h-60 minlg:h-300 overflow-hidden">
        <h1 className= {`${textStyles} font-poppins font-semibold  dark:text-white text-nft-black-1 text-xl minlg:text-xl sm:text-[1.4rem]`} >
          {content}
        </h1>
