...
const InfoCard = ({
  ...
  return (
    <div className="flex-1 min-w-215  max-w-max xs:max-w-none sm:w-full sm:min-w-fit minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-indigo-100 rounded-2xl my-4 ml-4 sm:ml-0 minlg:m-8 sm:my-2 shadow-md sm:p-10 p-10">
